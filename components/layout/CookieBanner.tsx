...
export function CookieBanner() {
  ...
  return (
    <div
      ...
      className="fixed bottom-0 left-0 right-0 z-[60] bg-navy-deep border-t border-navy-mid shadow-2xl"
    >
      <div className="container-site py-5 flex flex-col sm:flex-row items-start sm:items-center gap-4">
        ...
        <div className="flex items-center gap-3 flex-shrink-0">
          <button
            onClick={decline}
            className="font-mono text-xs uppercase tracking-widest text-muted-l hover:text-cream transition-colors px-4 py-2"
          >
            Refuz
          </button>
          <button
          ...
          <button
            onClick={decline}
            aria-label="Închide"
            className="p-1.5 text-muted-l hover:text-cream transition-colors ml-1"
          >
            <X className="h-4 w-4" />
          </button>
        </div>
