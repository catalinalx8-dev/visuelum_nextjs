  ...
  theme: {
    extend: {
      ...
      keyframes: {
        ...
        // Uses CSS var so the colour updates automatically when gold changes
        goldPulse: {
          '0%,100%': { boxShadow: `0 0 0 0 ${theme.colors.gold.DEFAULT}66` },
          '50%':     { boxShadow: `0 0 0 8px ${theme.colors.gold.DEFAULT}00` },
        },
        shimmer: {
